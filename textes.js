...
const texteArray = [
    ...
    {
        img: "./img/sneakers/BOOK_neel_honorine-41.png",
        groups: ["group2"],
        txt: 'SNEAKERS EVENT',
    },
    {
    ...
    {
        img: "./img/JIMMI HENDRIX/BOOK_neel_honorine-51.png",
        groups: ["group2"],
        txt: 'JIMMI HENDRIX',
    },
    {
    ...
    {
        img: "./img/METAMORPHOSE/Roman.jpg",
        groups: ["group2"],
        txt: 'LA métamorphose',
    },
    {
    ...
    {
        img: "./img/ARLES/NEEL_HONORINE_ARLES-1.jpg",
        groups: ["group2"],
        txt: 'ARLES',
